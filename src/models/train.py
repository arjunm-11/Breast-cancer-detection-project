...
from keras.preprocessing.image import ImageDataGenerator  # ✅ Use tensorflow.keras
from keras.callbacks import EarlyStopping, ModelCheckpoint  # ✅ Also change this
